...
async def get_genre_by_id(session: AsyncSession, genre_id: str) -> Genre | None:
...
async def update_genre(session: AsyncSession, genre_id: str, genre: GenreUpdate) -> Genre | None:
...
async def delete_genre(session: AsyncSession, genre_id: str) -> bool:
